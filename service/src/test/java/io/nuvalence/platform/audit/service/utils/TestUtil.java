...
public interface TestUtil {
    String ACTIVITY_EVENT_JSON = "/samples/activity_audit_event.json";
    ...
    String STATE_CHANGE_EVENT_JSON = "/samples/state_change_audit_event.json";

    /**
     * Test resources.
     */
    enum Data {
        ACTIVITY_EVENT(ACTIVITY_EVENT_JSON, io.nuvalence.events.event.AuditEvent.class),
        ...
        STATE_CHANGE_EVENT(STATE_CHANGE_EVENT_JSON, io.nuvalence.events.event.AuditEvent.class);
